  ...
  const handleConfirmRequest = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Sua solicitação de sessão foi enviada com sucesso!",
      })
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tem certeza que deseja solicitar uma sessão com {trainer.name} para o dia {selectedDate && format(new Date(selectedDate), "dd/MM/yyyy", { locale: ptBR })} às {selectedTime}?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel disabled={isSubmitting}>Cancelar</AlertDialogCancel>
            <AlertDialogAction onClick={handleConfirmRequest} className="bg-[#d30014] hover:bg-[#d30014]/90 text-white" disabled={isSubmitting}>
